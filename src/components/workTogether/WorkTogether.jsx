    ...
    <div className="py-25 max-w-169 mx-auto px-2">
      <div className="text-center">
        <p className="text-white md:font-semibold text-2xl sm:text-3xl md:text-5xl pb-8">
          Do you have a business challenge or project idea? Let’s discuss!
        </p>
        <p className="text-[#A5ACB5] text-xs sm:text-lg font-normal text-center pb-8">
          I’m always open to exploring new projects, analyzing requirements, and creating data-driven strategies that drive measurable results. Let’s connect and uncover growth opportunities together.
        </p>
        <a
          href="#contact"
